...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside className={cn(
        "w-72 h-[100dvh] md:h-full border-r border-white/5 bg-[#050505] flex flex-col fixed md:relative z-[70] transition-transform duration-300 left-0 top-0",
        isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
      )}>
        <button
          onClick={onClose}
          className="md:hidden absolute top-6 right-6 p-2 rounded-xl bg-white/5 text-white hover:bg-white/10 z-50 flex items-center justify-center"
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[7px] text-muted-foreground font-black uppercase tracking-[0.4em] mt-1">
                  {isAdminMode ? '' : 'Gestão de Talentos'}
                </p>
              </div>
            </div>
          ...
          {isAdminMode ? (
            ...
            <>
              ...
              <NavItem
                ...
                active={activeModule === "admin_studio_canvas"}
                onClick={() => onModuleChange("admin_studio_canvas")}
              />
              <NavItem
                icon={Image}
              ...
              {!isInfluencerSelected ? (
                ...
                <>
                  ...
                  <NavItem
                    icon={Layers}
                    label="Workflow Builder"
                    active={activeModule === "studio_canvas"}
                    onClick={() => onModuleChange("studio_canvas")}
                  />
                  <NavItem
                    icon={Image}
