...
import { updateInfluencer, createInfluencer } from "@/lib/actions"
...
export function InfluencerDashboard({
    ...
    const handleCreateNew = async (e: React.FormEvent) => {
        ...
        setIsCreating(true)
        try {
            const id = await createInfluencer(newInfluencerName, newInfluencerImage || undefined)
            onSelect(id)
                ...
                >
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-5xl font-black text-white tracking-tighter uppercase mb-4">
                            Expandir o <span className="text-primary italic">Casting</span>
                        </h2>
                        <p className="text-muted-foreground text-sm font-medium leading-relaxed italic max-w-sm mx-auto">
                            Inicie o processo de catalogaçao de um novo talento sintético no ecossistema Elite.
                        </p>
                    </div>

                    <form onSubmit={handleCreateNew} className="glass-card p-10 rounded-[3rem] border border-white/10 shadow-2xl space-y-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-primary uppercase tracking-[0.4em] ml-2">Identificação Nominal</label>
                            <input
                            ...
                            <label className="flex-1 cursor-pointer group">
                                <div className="p-8 bg-white/[0.02] border border-dashed border-white/10 rounded-3xl flex flex-col items-center gap-3 group-hover:bg-white/[0.05] transition-all">
                                    ...
                                    <span className="text-[9px] font-black text-muted-foreground uppercase tracking-widest text-center truncate w-full px-4">
                                        {newInfluencerImage ? newInfluencerImage.name : "Upload de Avatar Oficial"}
                                    </span>
                                </div>
                                <input
                                    type="file"
                        ...
                        >
                            {isCreating ? <Loader2 className="w-5 h-5 animate-spin mx-auto text-primary" /> : "Consolidar Identidade no Banco"}
                        </button>
                    </form>
                </motion.div>
            </div>
            ...
            <AnimatePresence>
                {showSaveSuccess && (
                    ...
                    >
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest">Dossiê Atualizado</span>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <div className="max-w-6xl mx-auto pb-32">
                        ...
                        <div className="mb-10 max-w-lg">
                            {isEditingMode ? (
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest ml-1">Curta Biografia (Instagram Style)</label>
                                    <textarea
                                        ...
                                        rows={3}
                                        placeholder="Ex: Exploradora digital vivendo na fronteira entre o real e o sintético. 🌌"
                                    />
                                </div>
                            ) : (
                                <p className="text-2xl font-bold text-white/50 leading-relaxed italic pr-12">
                                    "{editedData.short_bio || "Narrativa sintética em constante evolução."}"
                                </p>
                            )}
                        </div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-white/[0.02] border border-white/5 p-4 rounded-2xl">
                                    <div className="flex items-center gap-3 text-muted-foreground mb-1">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-widest">Base City</span>
                                    </div>
                                    {isEditingMode ? (
                                        <input
                                        ...
                                        <p className="text-sm font-bold text-white">{editedData.base_city || "Global"}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-white/[0.02] border border-white/5 p-4 rounded-2xl">
                                    <div className="flex items-center gap-3 text-muted-foreground mb-1">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-widest">Digital Age</span>
                                    </div>
                                    {isEditingMode ? (
                                        <input
                                            type="date"
                                        ...
                                        <p className="text-sm font-bold text-white">{getAge(editedData.date_of_birth)} ciclos</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-white/[0.02] border border-white/5 p-4 rounded-2xl">
                                    <div className="flex items-center gap-3 text-muted-foreground mb-1">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-widest">Zodiac</span>
                                    </div>
                ...
                <div className="pt-20 mt-20 border-t border-white/5">
                    <div className="flex items-center gap-6 mb-12">
                        ...
                        <div>
                            <h3 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">Dossiê Narrativo <span className="text-primary italic">Estendido</span></h3>
                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.4em] mt-2">Profundidade de Personagem & Storytelling</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-8 mb-20">
                        ...
                        <div className="col-span-12 lg:col-span-4 space-y-4">
                            {[
                                { icon: User, label: "Gênero Narrativo", fieldPath: "sex", value: editedData.dossier?.sex },
                                { icon: Cross, label: "Crenças / Faith", fieldPath: "faith", value: editedData.dossier?.faith },
                                { icon: Briefcase, label: "Profissão / Career", fieldPath: "career", value: editedData.dossier?.career },
                                { icon: GraduationCap, label: "Educação / Formação", fieldPath: "education", value: editedData.dossier?.education },
                            ].map((item, i) => (
                        ...
                        <div className="col-span-12 lg:col-span-8 space-y-8">
                            <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[2.5rem] relative group min-h-[220px]">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h4 className="text-[10px] font-black text-white uppercase tracking-[0.3em]">Origens & Trajetória (História Longa)</h4>
                                </div>
                                {isEditingMode ? (
                                    <textarea
                                        ...
                                        placeholder="Descreva a história detalhada do influenciador..."
                                    />
                                ) : (
                                    <p className="text-sm font-medium leading-[2] text-white/60 italic text-justify pr-10">
                                        {editedData.backstory || "A trajetória deste talento ainda está sendo escrita no silício das nossas redes. Uma vida dedicada à fusão entre o estético e o funcional."}
                                    </p>
                                )}
                            ...
                            <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[2.5rem] relative group">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h4 className="text-[10px] font-black text-white uppercase tracking-[0.3em]">Sonhos & Objetivos Estratégicos</h4>
                                </div>
                                {isEditingMode ? (
                                    <textarea
                                        ...
                                        placeholder="Quais são os principais objetivos narrativos?"
                                    />
                                ) : (
                                    <p className="text-sm font-medium leading-[2] text-white/60 italic text-justify pr-10">
                                        {editedData.dossier?.goals || "Conquista de influência global e estabelecimento de um novo padrão estético."}
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="space-y-24 pb-20">
                        <div>
                            <div className="flex items-center gap-6 mb-12">
                                ...
                                <div>
                                    <h3 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">Curadoria <span className="text-primary italic">Visual</span></h3>
                                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.4em] mt-2">Moodboard & Referências de Atuação</p>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="flex items-center gap-6 mb-12">
                                ...
                                <div>
                                    <h3 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">Destaques <span className="text-primary italic">Portfólio</span></h3>
                                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.4em] mt-2">Assets liberados para compartilhamento com clientes</p>
                                </div>
                            </div>
